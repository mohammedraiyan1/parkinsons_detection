...
export default function GaitTestScreen({ navigation }: any) {
  ...
  useEffect(() => {
    ...
    if (isRecording) {
      ...
      subscription = Accelerometer.addListener(motionData => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Gait Test</Text>
      <Text style={styles.instructions}>
        Hold your phone in your hand. When you press start, walk 10 steps forward normally, turn around, and walk 10 steps back.
      </Text>
      ...
      {!isRecording && timeLeft > 0 && (
        <TouchableOpacity style={styles.startBtn} onPress={() => setIsRecording(true)}>
          <Text style={styles.startText}>Start Walking</Text>
        </TouchableOpacity>
      )}
